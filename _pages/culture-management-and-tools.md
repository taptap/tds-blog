...
如果你对在 TapTap 工作感兴趣，可以在[这个页面](/career)找到开放的职位。如果你希望对我们的技术职位面试过程了解更多，可以看[技术面试指南](/pages/tech-interview-guide)。
...
- 代码管理：GitLab（非开源项目）、[GitHub](https://github.com/taptap)（开源项目）
