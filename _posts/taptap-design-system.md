# 从服务出发，打造生长·包容·全面的 TapTap 企业级设计系统

## TapTap Design System｜Developers 是 ...

TapTap Design System｜Developers 是由 TapTap Design Team B 端设计团队（TDS UX Design），基于游戏开发者平台领域，提炼出来的全面、易用的 UI 解决方案。
设计团队经过多次对项目中，不同业务场景的探索和积累，已逐步沉淀为一个丰富的、全面的、成熟的 UI 设计系统，为 TapTap 内外部各企业级业务提供设计支持。
...
1.将 TapTap Design System｜Developers 组件库资源复制到你的**团队**项目中
...
我们发布的第一周，即获得了 Figma 社区的热门推荐，全球用户们的热情收藏下载，数据表现超过设计团队的原有预期，
